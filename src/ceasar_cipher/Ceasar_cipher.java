...
public class Ceasar_cipher {
    /*
    2-SORU SEZAR ŞİFRELEME (STRİNG MANIPULATIONS SORUSU)
Sezar şifreleme: İlk kez Romalı lider Jül Sezar tarafından kullanılmış olan şifreleme tekniğidir. Bu şifreleme en basit ve en bilinen şifreleme tekniklerinden birisidir.
Düz metindeki her harfin, alfabenin belirli bir sayı ileride konumlu olan bir harfle değiştirildiği bir şifreleme türüdür.
ÖRNEK=  hello -----> ıfmmp  ----> 1 birim kaydırılmış hali
     */
